    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('canteens', models.ManyToManyField(related_name='orders', to='canteen.canteen')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('canteen', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='items', to='canteen.canteen')),
